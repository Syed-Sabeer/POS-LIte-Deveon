...
@section('content')
<div class="page-header no-print"><div class="page-title"><h4 class="fw-bold">Supplier Statement - {{ $supplier->full_name }}</h4></div><div class="page-btn"><button onclick="window.print()" class="btn btn-primary">Print</button></div></div>
